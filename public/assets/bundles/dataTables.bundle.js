!(function (n) {
    ...
    var e = t.aoColumns[e],
      ...
      i =
        ...
        n !== N &&
          ...
          u !== e.sClass && (e.sclassName = u + " " + e.sClass),
  ...
  function T(t, e, n, r) {
    ...
    return (
      e !== N && (t.aIds[e] = o),
      (!n && t.oFeatures.bDeferRender) || vt(t, a, n, r),
      a
    );
  }
  function ut(n, t) {
  ...
  function Rt(t, e, n) {
    ...
    var o = t.oPreviousSearch,
      i = t.aoPreSearchCols;
    if ((st(t), "ssp" != E(t))) {
      Nt(t, e.sSearch, n, a(e), e.bSmart, e.bCaseInsensitive, e.return), r(e);
  ...
  function jt(t, e, n, r, a, o) {
    if ("" !== e) {
      for (
        var i, s = [], l = t.aiDisplay, u = kt(e, r, a, o), c = 0;
        c < l.length;
        c++
      )
  ...
  function Kt(n) {
    ...
    n.scrollBarVis !== R && n.scrollBarVis !== N
      ...
      : ((n.scrollBarVis = R),
        ...
        (p[(i = "padding" + (x.bScrollbarLeft ? "Left" : "Right"))] = S
          ? s + "px"
          : "0px"),
        C &&
          ((y[0].style.width = W(R)),
  ...
  function ee(t) {
    ...
    for (b && -1 !== b.indexOf("%") && (d = b), D = 0; D < u.length; D++)
      null !== (e = a[u[D]]).sWidth &&
        ((e.sWidth = re(e.sWidthOrig, f)), (h = !0));
    if (g || (!h && !s && !i && l == x(t) && l == c.length))
      ...
      if (t.aoData.length)
        for (D = 0; D < u.length; D++)
          (e = a[(n = u[D])]),
            P(ae(t, n)).clone(!1).append(e.sContentPadding).appendTo(v);
  ...
  function ie(t) {
    var e,
      ...
      o = (t.aoColumns, 0),
      i = t.aiDisplayMaster;
    for (st(t), e = 0, n = (c = I(t)).length; e < n; e++)
      (a = c[e]).formatter && o++, de(t, a.col);
  ...
  var Ie = [],
    ...
    Fe =
      ...
      P.extend(B.prototype, {
        ...
        iterator: function (t, e, n, r) {
          ...
          return f.length || r
            ? (((t = (r = new B(h, t ? f.concat.apply([], f) : f))
      ...
      (B.register = e =
        function (t, e) {
          if (Array.isArray(t))
            for (var n = 0, r = t.length; n < r; n++) B.register(t[n], e);
          else
            for (
              var a = t.split("."), o = Ie, i = 0, s = a.length;
              i < s;
              i++
            ) {
              var l,
          ...
          function (t) {
            return _e(
              ...
              function (n) {
                ...
                if (((i = i || Fe(a, o)), null !== t && -1 !== P.inArray(t, i)))
                  return [t];
    ...
    ke =
          ...
          d !== N &&
            this.iterator("table", function (t) {
              Dt(t, t.aoHeader),
                Dt(t, t.aoFooter),
                t.aiDisplay.length ||
                  P(t.nTBody).find("td[colspan]").attr("colspan", x(t)),
                fe(t),
      ...
      (w.use = function (t, e) {
        "lib" === e || t.fn
          ? (P = t)
          : ("win" != e && !t.document) || (S = (j = t).document);
      }),
          ...
          this.iterator("table", function (e) {
            var n,
              ...
              i =
                ...
                r != o.parentNode &&
                  (s.children("thead").detach(), s.append(o)),
                i &&
                  r != i.parentNode &&
  ...
  if (Intl)
    try {
      for (
        var ze = new Intl.NumberFormat().formatToParts(100000.1), n = 0;
        n < ze.length;
        n++
      )
        "group" === ze[n].type
  ...
  (function (n) {
    ...
    "function" == typeof define && define.amd
      ...
      ? ((r = require("jquery")),
        ...
        "undefined" != typeof window
          ? (module.exports = function (t, e) {
              return (
                (t = t || window), (e = e || r(t)), a(t, e), n(e, 0, t.document)
              );
            })
    ...
    return (
      ...
      (i.ext.renderer.pageButton.bootstrap = function (s, t, l, e, u, c) {
        ...
        r.length
          ? r.empty()
          : (r = t.html("<ul/>").children("ul").addClass("pagination")),
          d(r, e),
    ...
    function s(t, e) {
      ...
      (this.s = {
        ...
        this.s.dt.settings()[0].responsive ||
          ...
          (this.c = p.extend(!0, {}, s.defaults, a.defaults.responsive, e)),
            ...
            o &&
              ...
              ((n =
                "string" == typeof o.renderer
                  ...
                  : o.renderer),
              (!0 !==
                (o = o.display(t, e, function () {
                  return n.call(r, a, t[0], r._detailsObj(t[0]));
                })) &&
                !1 !== o) ||
