!(function (t, e) {
  ...
  (t.prototype.getDistance = function (t) {
      ...
      return (
        ...
        (t = t) >= e.slice(-1)[0]
          ...
          : ((n = e[(o = l(t, e)) - 1]),
            ...
            (o = r[o]),
            e +
              a((i = [n, i]), i[0] < 0 ? t + Math.abs(i[0]) : t - i[0], 0) /
                s(e, o))
      );
      var e, r, n, i, o;
    }),
        ...
        100 === (t = t)
          ...
          : ((o = e[(i = l(t, e)) - 1]),
            ...
            n
              ...
              : r[i - 1]
              ? e[i - 1] +
                ((e = t - e[i - 1]), (i = r[i - 1]), Math.round(e / i) * i)
              : t)
      );
      var e, r, n, i, o, s;
    }),
    ...
    (t.prototype.handleEntryPoint = function (t, e) {
      if (
        !i((t = "min" === t ? 0 : "max" === t ? 100 : parseFloat(t))) ||
        !i(e[0])
      )
  ...
  function j(t, d, o) {
    ...
    function H(t, c) {
      ...
      return (
          ...
          r.addEventListener("keydown", function (t) {
            ...
            if (!_() && !v(e)) {
              ...
              if ((t.preventDefault(), n || i)) {
                ...
                !1 === u &&
                  (u = y.getDefaultStep(f[e], i, d.keyboardDefaultStep)),
                  (u *=
                    l || a ? d.keyboardPageMultiplier : d.keyboardMultiplier),
                  (u = Math.max(u, 1e-7)),
                  (u = p[e] + (u *= i ? -1 : 1));
              } else
                u = o
        ...
        0 === c
          ? dt(r, d.cssClasses.handleLower)
          : c === d.handles - 1 && dt(r, d.cssClasses.handleUpper),
        (t.handle = r),
        t
      );
    }
    ...
    function R(t, e) {
      return (
        ...
        E(t.firstChild, d.cssClasses.tooltip)
      );
    }
    function _() {
      ...
      (h = (function (t) {
        ...
        h.forEach(function (t, e) {
          ...
          for (
            ...
            for (
              a = (o = (i = y.toStepping(r)) - v) / (f.density || 1),
                u = o / (l = Math.round(a)),
                n = 1;
              n <= l;
              n += 1
            )
              m[(s = v + n * u).toFixed(5)] = [y.fromStepping(s), 0];
            (a =
              -1 < h.indexOf(r)
      ...
      return (S = x.appendChild(
        ...
        Object.keys(i).forEach(function (t) {
          ...
          (n = o ? o(r, n) : n) !== ot.PipsType.None &&
            (((t = E(a, !1)).class = p(n, d.cssClasses.marker)),
            (t.style[d.style] = e + "%"),
            n > ot.PipsType.NoValue) &&
            (((t = E(a, !1)).class = p(n, d.cssClasses.value)),
          ...
          r = (function (e, t, r) {
            ...
            if (n) {
              ...
              if ("touchstart" === e.type) {
                if (1 < (n = Array.prototype.filter.call(e.touches, l)).length)
                  return !1;
    ...
    function W(t, e) {
      if (
        ...
        return A(t, e);
      G(
        0 < (t = (d.dir ? -1 : 1) * (t.calcPoint - e.startCalcPoint)),
        (100 * t) / e.baseSize,
        e.locations,
        e.handleNumbers,
        e.connect
    ...
    function A(t, e) {
      e.handle && (ft(e.handle, d.cssClasses.active), --s),
        ...
        0 === s &&
          (ft(x, d.cssClasses.drag), K(), t.cursor) &&
          ((b.style.cursor = ""), b.removeEventListener("selectstart", lt)),
    ...
    function k(t, e) {
      ...
      e.handleNumbers.some(v) ||
        ...
        t.cursor &&
          ((b.style.cursor = getComputedStyle(t.target).cursor),
          1 < l.length && dt(x, d.cssClasses.drag),
          b.addEventListener("selectstart", lt, !1)),
        e.handleNumbers.forEach(function (t) {
          M("start", t);
        }));
    }
    ...
    function r(t) {
      ...
      Object.keys(m).forEach(function (t) {
        ...
        (n && n !== e) ||
          (i && i !== r) ||
          (((r !== mt.aria && r !== mt.tooltips) || i === r) && delete m[t]);
      });
    }
    function M(r, n, i) {
      Object.keys(m).forEach(function (t) {
    ...
    function U(t, e, r, n, i, o, s) {
      ...
      return (
        1 < l.length &&
          ...
          (n &&
            0 < e &&
            ((a = y.getAbsoluteDistance(t[e - 1], d.margin, !1)),
            (r = Math.max(r, a))),
          i) &&
          e < l.length - 1 &&
          ((a = y.getAbsoluteDistance(t[e + 1], d.margin, !0)),
          (r = Math.min(r, a))),
        1 < l.length &&
          d.limit &&
          (n &&
            0 < e &&
            ((a = y.getAbsoluteDistance(t[e - 1], d.limit, !1)),
            (r = Math.min(r, a))),
          i) &&
          e < l.length - 1 &&
          ((a = y.getAbsoluteDistance(t[e + 1], d.limit, !0)),
          (r = Math.max(r, a))),
        d.padding &&
          (0 === e &&
            ((a = y.getAbsoluteDistance(0, d.padding[0], !1)),
            (r = Math.max(r, a))),
          e === l.length - 1) &&
          ((a = y.getAbsoluteDistance(100, d.padding[1], !0)),
          (r = Math.min(r, a))),
    ...
    function D(t, e, r, n, i, o) {
      return (
        !1 !== (e = i ? e : U(f, t, e, r, n, !1, o)) &&
        ((f[t] = e),
        (p[t] = y.fromStepping(e)),
        (e = "translate(" + $(J(e, 0) - z + "%", "0") + ")"),
    ...
    function Z(t, e) {
      return null === t ||
        ...
        !1 === (t = !1 !== (t = d.format.from(t)) ? y.toStepping(t) : t)) ||
        isNaN(t)
        ? f[e]
        : t;
    }
    ...
    dt((t = x), d.cssClasses.target),
      ...
      0 === d.ort
        ? dt(t, d.cssClasses.horizontal)
        : dt(t, d.cssClasses.vertical),
      dt(
        t,
    ...
    (l = []), (a = []).push(F(it, rt[0]));
    for (var L = 0; L < d.handles; L++)
      l.push(H(nt, L)), (h[L] = L), a.push(F(it, rt[L + 1]));
    (u = d.events).fixed ||
      l.forEach(function (t, e) {
          ...
          function (t) {
            ...
            var i,
              ...
              r =
                ...
                s);
            !1 !== r &&
              (d.events.snap || ut(x, d.cssClasses.tap, d.animationDuration),
              D(r, e, !0, !0),
              K(),
              M("slide", r, !0),
              M("update", r, !0),
