$(function () {
  ...
  var chart = new ApexCharts(document.querySelector("#sparkline-pie"), options);
  chart.render();
  ...
  var chart = new ApexCharts(
    document.querySelector("#Salary_Statistics"),
    options
  );
  chart.render();
  ...
  var chartSpark1 = new ApexCharts(
    document.querySelector("#total_Salary"),
    optionsSpark1
  );
  chartSpark1.render();
  ...
  var chart = new ApexCharts(
    document.querySelector("#apex-TotalStudent"),
    options
  );
  chart.render();
  ...
  new ApexCharts(
    document.querySelector("#sparkbar_uideveloper"),
    options1
  ).render();
  ...
  new ApexCharts(
    document.querySelector("#sparkbar_designer1"),
    options1
  ).render();
  ...
  new ApexCharts(
    document.querySelector("#sparkbar_developer"),
    options1
  ).render();
  ...
  new ApexCharts(
    document.querySelector("#sparkbar_designer"),
    options1
  ).render();
});
